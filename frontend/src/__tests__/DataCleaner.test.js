...
describe('Data cleaner', () => {
    ...
    it('Separates data into one class with one class and one section', () => {
        // get the data in some way and try to clean it
        // result should return a list of class objects
        let result = DataCleaner.cleanData(testResult);
